...
bool ConfigManager::load()
{
	...
	integer[KILLS_TO_RED] = getGlobalNumber(L, "killsToRedSkull", 4);
	integer[KILLS_TO_BLACK] = getGlobalNumber(L, "killsToBlackSkull", 8);
	...
	integer[PROTECTION_LEVEL] = getGlobalNumber(L, "protectionLevel", 8);
	...
	integer[FRAG_TIME] = getGlobalNumber(L, "timeToDecreaseFrags", 8 * 60 * 60 * 1000);
	integer[WHITE_SKULL_TIME] = getGlobalNumber(L, "whiteSkullTime", 10 * 60 * 1000);
	integer[STAIRHOP_DELAY] = getGlobalNumber(L, "stairJumpExhaustion", 2000);
	integer[EXP_FROM_PLAYERS_LEVEL_RANGE] = getGlobalNumber(L, "expFromPlayersLevelRange", 1);
	...
	integer[DAY_KILLS_TO_RED] = getGlobalNumber(L, "dayKillsToRedSkull", 4);
	integer[WEEK_KILLS_TO_RED] = getGlobalNumber(L, "weekKillsToRedSkull", 20);
	integer[MONTH_KILLS_TO_RED] = getGlobalNumber(L, "monthKillsToRedSkull", 60);
	integer[RED_SKULL_DURATION] = getGlobalNumber(L, "redSkullDuration", 3);
	integer[BLACK_SKULL_DURATION] = getGlobalNumber(L, "blackSkullDuration", 7);
	integer[ORANGE_SKULL_DURATION] = getGlobalNumber(L, "orangeSkullDuration", 3);
